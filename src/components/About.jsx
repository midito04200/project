  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Nos Services */}
        <div className="prose prose-lg">
          <h3 className="text-2xl font-amiri text-secondary-green mb-4">Nos Services</h3>
        ...
        {/* Nos Objectifs */}
        <div className="prose prose-lg">
          <h3 className="text-2xl font-amiri text-secondary-green mb-4">Nos Objectifs</h3>
          <ul className="list-disc pl-6 text-gray-600">
            <li>Offrir un lieu de culte accueillant et accessible à tous les fidèles</li>
            <li>Dispenser des cours d'éducation religieuse pour enfants et adultes</li>
