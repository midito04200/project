    ...
    <div className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bodrum text-gray-900 mb-4">Nos Activités</h2>
          <p className="text-xl text-gray-600">Découvrez les activités régulières de notre mosquée</p>
        </div>
          ...
          {loading ? (
            ...
            activities?.map((activity) => (
              ...
              >
                ...
                <h3 className="text-xl font-bodrum text-center mb-4">{activity.title}</h3>
